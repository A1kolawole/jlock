...
def print_help_welcome():
    print('\t\t', 'JLOCK Help')
    print('\t\t', '(c)2023 A1kolawole ')
    return


def print_lock_help():
# print the help info for the -lock command
    print('\t-lock'
...
# print the help info for the -unlock command
    print('\t-unlock'
...
def print_msg_help():
# print the help info for the -msg command
    print('\t-msg'
...
# print the help info for the -locked command
    print('\t-locked'
